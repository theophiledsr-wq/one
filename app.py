...
        }, index=final_list)
        st.table(comp_df)
        st.metric("Sharpe Optimal", f"{res[2, best_idx]:.2f}", f"{res[2, best_idx]-curr_sharpe:.2f}")Modifie ce code pour que le menu de selection de tickers affiche le nom complet correspondant
